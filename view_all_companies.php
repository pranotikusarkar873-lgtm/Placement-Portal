...
// Fetch all companies (always show full list)
...
<head>
    <meta charset="UTF-8">
    <title>Company Report - Placement Management System</title>
...
<div class="container mt-5 d-flex justify-content-between align-items-center">
    <h3 class="mb-4 m-0">Company Reports</h3>
...
<div class="container">
    ...
    <?php if (!empty($filtered_companies)): ?>
        <div class="card shadow p-4 mb-4">
            <h5>Filtered Companies (<?= htmlspecialchars($start_date); ?> to <?= htmlspecialchars($end_date); ?>)</h5>
    ...
    <div class="card shadow p-4">
        <h5>All Companies Registered</h5>
        <table class="table table-bordered table-striped mt-3">
            <thead class="table-dark">
                <tr>
                    <th>ID</th>
