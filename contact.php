...
<body>
        ...
        <div class="row py-2 px-lg-5">
            <div class="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center text-white">
                    <small><i class="fa fa-phone-alt mr-2"></i>TPO no.</small>
                    <small class="px-3">|</small>
                    <small><i class="fa fa-envelope mr-2"></i>TPO MAIL</small>
                </div>
            </div>
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-0">
            ...
            <div class="d-inline-flex text-white mb--1">
                ...
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="mt-n1">
                                <h4>Our Location</h4>
                                <p class="m-0">Gokul shirgaon,Kolhapur</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-5">
    ...
    <div class="container-fluid bg-dark text-white-40 border-top py-1" style="border-color: rgba(256, 256, 256, .1) !important;">
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                    <a class="text-white" href="index.php">Placement Portal</a>.
                    </p>
                </div>
